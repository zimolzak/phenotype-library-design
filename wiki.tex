...
\marginnote{More about our current wiki: It uses MediaWiki, which is
  ...
  of copy-pasting of markup code, and a range of other features. I'm
  more than happy to help with creating templates and dealing with
  markup. The MediaWiki instance hosted for us by VINCI is currently
  having authentication problems, however.}
