...
\marginnote{More about MediaWiki: MediaWiki is the software that makes
  Wikipedia run, but anyone can install it to their Web server to
  create their own wiki. MediaWiki uses its own markup language called
  wikitext. Templates avoid a \emph{lot} of copy-pasting of wikicode.
  I'm more than happy to help with creating templates and dealing with
  markup.}
...
%%  LocalWords:  LOINCs TestNames subfolders
